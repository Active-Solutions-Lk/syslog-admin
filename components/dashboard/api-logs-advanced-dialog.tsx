  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {/* Scroll-snap container: shows one section at a time (stats -> table) */}
        <div className="p-6 flex-grow overflow-y-auto snap-y snap-mandatory min-h-0">
          <section className="snap-start h-full relative">
            ...
            {/* small hint to indicate user can scroll */}
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-xs text-muted-foreground">
              Scroll for detailed logs ↓
            </div>
          </section>

          <section className="snap-start h-full flex flex-col overflow-hidden">
